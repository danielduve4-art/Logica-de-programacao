...
// a)
let cores =["amarelo", "verde", "azul", "vermelho"]
// b)
...
cores.shift()
// c)
console.log(cores, "e o seu total é:", cores.length)
...
// a)
let nada
let dados = ["Valorant", 23, true, nada, null]
// b)
...
// a)
let vazio
let feijaovermelho = false
let variedadeDeDados = [ vazio, "arroz", 1, "batata", feijaovermelho, null]
// b)
console.log(variedadeDeDados)
// c)
variedadeDeDados.pop(), variedadeDeDados.shift()
// d)
console.log(variedadeDeDados)
// e)
variedadeDeDados.push("macarrao"), variedadeDeDados.unshift("cafe")
// f)
console.log(variedadeDeDados)
